        ...
        <Sections>
          <Section>
            <p>
              ...
              been plenty of ideas — big and small — have come to be shared in
              the community.
            </p>
            <p>
              Welcome to{' '}
          ...
          <Section>
            ...
            <p>
              We use Git, GitHub, Figma, VS Code, HTML5, CSS3, JavaScript,
              React, React Hot Reload, React Router, React Helmet, Emotion,
              Redux, Netlify, Node.js, Express, MongoDB, Mongoose, MySQL,
              Knex.js, Objection.js, Heroku, Google Cloud Platform, and variety
              of other tools on Linux and macOS.
            </p>
          </Section>
        </Sections>
      </Center>
